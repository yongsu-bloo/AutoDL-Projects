...
def main(args):
  ...
  if args.model_config is None:
    model_config = dict2config({'name': 'GDAS', 'C': args.channel, 'N': args.num_cells,
...
if __name__ == '__main__':
  ...
  parser.add_argument("--version",            type=int,  default=3,      help="Search method version")
  # Transfer layer
  ...
  parser.add_argument('--config_path',        type=str,   default="configs/nas-benchmark/algos/transfer-GDAS.config", help='The path of the configuration.')
