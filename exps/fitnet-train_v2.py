...
def main(args):
  ...
  for epoch in range(start_epoch, total_epoch):
    ...
    train_loss, train_acc1, train_acc5, train_matching_loss, train_kd_loss \
        = train_func(train_loader, teacher, network, matching_layers, criterion, w_scheduler, w_optimizer, optim_config, epoch_str, args.print_freq, logger, kd_coef=kd_coef, version=2)
    ...
    if (epoch % args.eval_frequency == 0) or (epoch + 1 == total_epoch):
      ...
      valid_loss, valid_acc1, valid_acc5, valid_matching_loss, valid_kd_loss \
        = valid_func(valid_loader, teacher, network, matching_layers, criterion, optim_config, epoch_str, args.print_freq_eval, logger, kd_coef=kd_coef, version=2)
...
if __name__ == '__main__':
  ...
  # Save and Load
  parser.add_argument('--save_dir',           type=str,   default="./output/transfer-train-v2",     help='Folder to save checkpoints and log.')
